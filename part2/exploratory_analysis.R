...
# zoom in plots
zoomin_start <- as.Date("2017-03-01")
zoomin_end <- as.Date("2017-03-31")
zoomin_ind <- which(zoomin_start <= data_agg_clean_total$date & data_agg_clean_total$date <= zoomin_end)
GetLineplot(dataset = data_agg_clean_total[zoomin_ind,], "cell", filepath = "plots/total_zoomin_") 
...
GetLineplot(dataset = data_agg_total_trans_log, "cell", filepath = "plots/transform/all_log_") 
